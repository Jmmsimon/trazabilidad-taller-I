...
import { Shield, AlertCircle, Loader2, Lock, Mail, ArrowLeft } from "lucide-react";
...
export default function AdministradorLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-purple-650/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-650 rounded-2xl mx-auto flex items-center justify-center mb-4 shadow-lg shadow-purple-500/20">
        ...
        <div className="backdrop-blur-xl bg-zinc-900/40 border border-zinc-800/50 rounded-3xl p-8 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleEmailLogin} noValidate className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  required
                  placeholder="administrador@upao.edu.pe"
                  value={email}
            ...
            <button
              ...
              className="w-full mt-2 bg-purple-600 hover:bg-purple-500 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer text-sm"
            >
